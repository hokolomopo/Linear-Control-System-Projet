...
print(acceleration, 'graphs/accLSFilterNoisy', '-depsc2');
print(difference, 'graphs/diffLSFilterNoisy', '-depsc2');
print(bodePlot, 'graphs/bodeLSFilterNoisy', '-depsc2');
print(nsqPlot, 'graphs/nyquistLSFilterNoisy', '-depsc2');
...
print(acceleration, 'graphs/accLSFilterNoisy','-dpng', '-r500');
print(difference, 'graphs/diffLSFilterNoisy','-dpng', '-r500');
print(bodePlot, 'graphs/bodeLSFilterNoisy','-dpng', '-r500');
print(nsqPlot, 'graphs/nyquistLSFilterNoisy','-dpng', '-r500');
